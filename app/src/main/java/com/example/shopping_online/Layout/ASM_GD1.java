    ...
    private void add_item_goto_Server() {
        ...
        btn_submit.setOnClickListener(v -> {
            ...
            try {
                ...
                Toast.makeText(ASM_GD1.this, "Giá không hợp lệ. Vui lòng nhập số.", Toast.LENGTH_SHORT).show();
                return;
            }

            // Validate date format (XX/XX/XX)
            if (!date_new.matches("\\d{2}/\\d{2}/\\d{4}")) {
                Toast.makeText(ASM_GD1.this, "Ngày phải có định dạng XX/XX/XXXX", Toast.LENGTH_SHORT).show();
                return;
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            try {
                ...
                e.printStackTrace();
                Toast.makeText(ASM_GD1.this, "Lỗi khi lấy ảnh", Toast.LENGTH_SHORT).show();
            }
        }
    }
}