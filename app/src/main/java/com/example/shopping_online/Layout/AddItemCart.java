...
public class AddItemCart extends AppCompatActivity {
    ...
    private Toolbar toolbarAddCardLayout;
    private TextView txt_Submit_Add_Card;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_Submit_Add_Card = findViewById(R.id.txt_Submit_Add_Card);
        toolbarAddCardLayout = findViewById(R.id.toolbarAddCardLayout);
        ...
        getSupportActionBar().setTitle("Thêm ngân hàng");
    ...
    private void validateEditTextWhenSubmit() {
        String number = edt_Number_Card.getText().toString().trim();
        String cvv = edt_CVV_Card.getText().toString().trim();
        String date = edt_Date_Card.getText().toString().trim();
        String user = edt_Username_Card.getText().toString().trim();
        ...
        if (isValid) {
            ...
            firestore.collection("users").document(userId).collection("card").add(item).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                ...
                public void onSuccess(DocumentReference documentReference) {
                    ...
                    startActivity(new Intent(AddItemCart.this, MyCard_Layout.class));
                }
    ...
    private void validatetext() {
        edt_Number_Card.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                String numbercard = edt_Number_Card.getText().toString().trim();
        ...
        edt_CVV_Card.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                String CVVcard = edt_CVV_Card.getText().toString().trim();
                if(CVVcard.length() != 3){
                    layout_CVV_Card.setError("CVV phải gồm 3 số!");
                }
                else{
        ...
        edt_Date_Card.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                String datecard = edt_Date_Card.getText().toString().trim();
