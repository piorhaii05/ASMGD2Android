                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        for (DocumentSnapshot document : productDocuments) {
                            ...
                            batch.set(userProductRef, product);
                        }
                        ...
                        batch.commit().addOnCompleteListener(commitTask -> {
                            if (commitTask.isSuccessful()) {
                                ...
                                Toast.makeText(Register_Layout.this, "Di chuyển sản phẩm thất bại!", Toast.LENGTH_SHORT).show();
                            }
                        });

                    } else {
                        Toast.makeText(Register_Layout.this, "Lấy sản phẩm thất bại!", Toast.LENGTH_SHORT).show();
                    }
                });
    }
