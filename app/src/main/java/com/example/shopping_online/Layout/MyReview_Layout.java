...
public class MyReview_Layout extends AppCompatActivity {

    private Toolbar toolbarMyReviewLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Khởi tạo toolbar
        toolbarMyReviewLayout = findViewById(R.id.toolbarMyReviewLayout);
