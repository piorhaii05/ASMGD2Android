...
public class AllProduct_Layout extends AppCompatActivity {
    private Toolbar toolbarAllProductLayout;
    private RecyclerView RecyclerViewAllProductLayout;
    private FirebaseFirestore firestore;
    private ArrayList<ProductModel> list;
    private ArrayList<ProductModel> filteredList;
    private ProductAllAdapter adapter;
    private EditText edtSearchViewAllProduct;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarAllProductLayout = findViewById(R.id.toolbarAllProductLayout);
        RecyclerViewAllProductLayout = findViewById(R.id.RecyclerViewAllProductLayout);
        edtSearchViewAllProduct = findViewById(R.id.edtSearchViewAllProduct);
    ...
    private void loadDataProductFromFireBase() {
        ...
        firestore.collection("users").document(userId).collection("product").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(AllProduct_Layout.this, "Load dữ liệu lỗi", Toast.LENGTH_LONG).show();
            }
        });
    }
