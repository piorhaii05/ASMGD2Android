...
import com.example.shopping_online.Layout.DetailProduct_Layout;
...
public class ProductAllAdapter extends RecyclerView.Adapter<ProductAllAdapter.ViewHolderProductAll> {
    ...
    public void onBindViewHolder(@NonNull ViewHolderProductAll holder, int position) {
        ...
        checkStatusAll = productModel.isStatus_product();
    ...
    private void goToAllProductDetail(ViewHolderProductAll holder, int position) {
        ...
        Intent intent = new Intent(context, DetailProduct_Layout.class);
    ...
    class ViewHolderProductAll extends RecyclerView.ViewHolder {
        ImageView image_items_product_all;
        TextView txt_items_add_to_listlike_all, txt_name_items_product_all, txt_describe_items_product_all, txt_price_items_product_all, txt_rating_items_product_all;
        LinearLayout item_all_product_go_to_deltail;
