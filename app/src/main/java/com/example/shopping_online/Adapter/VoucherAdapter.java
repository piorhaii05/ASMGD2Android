...
import com.example.shopping_online.Layout.Payment_Layout;
...
public class VoucherAdapter extends RecyclerView.Adapter<VoucherAdapter.ViewHolderVoucher> {
    ...
    private boolean checkStatusVoucher;
    ...
    private void useVoucherAndReturnToPayment(VoucherModel voucherModel) {
        ...
        Intent intent = new Intent(context, Payment_Layout.class);
    ...
    static class ViewHolderVoucher extends RecyclerView.ViewHolder {
        ImageView imageItemVoucher;
        TextView txtDateItemVoucher, txtTitleItemVoucher, txtStatusItemVoucher, txtUseVoucherOnList, txtUnderLineUse, txtRadiusItemVoucher;
