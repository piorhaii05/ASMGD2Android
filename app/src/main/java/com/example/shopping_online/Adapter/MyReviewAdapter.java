...
public class MyReviewAdapter extends RecyclerView.Adapter<MyReviewAdapter.ViewHolderMyReview> {
    ...
    class ViewHolderMyReview extends RecyclerView.ViewHolder {
        ImageView imageAvatarItemMyReview, imageProductItemMyReview;
        TextView txtNameItemMyReview, txtRatingItemMyReview, txtDescribeItemMyReview, txtDateItemMyReview, txtColorItemMyReview, txtSizeItemMyReview;
