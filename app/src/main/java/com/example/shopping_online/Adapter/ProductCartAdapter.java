...
public class ProductCartAdapter extends RecyclerView.Adapter<ProductCartAdapter.ViewHolderProductCart> {
    ...
    class ViewHolderProductCart extends RecyclerView.ViewHolder {
        ...
        private CheckBox checkboxItemsProductCart;
        private ImageView imageItemsProductCart;
        private TextView txtNameItemsProductCart, txtPriceItemsProductCart, txtMinusQuantityProduct, txtQuantityProduct, txtPlusQuantityProduct, txtDeleteItemsProductCart, txtAllPriceCart, txtColorItemsProductCart, txtSizeItemsProductCart;
        ...
        public ViewHolderProductCart(@NonNull View itemView) {
            ...
            txtAllPriceCart = itemView.findViewById(R.id.txtAllPriceCart);
    ...
    public void calculateTotalPrice() {
        ...
        if (context instanceof Cart_Layout) {
            ((Cart_Layout) context).updateTotalPriceUI(totalPrice);
        }
    }
    ...
    private void StatusAllSelectItem() {
        ...
        if (context instanceof Cart_Layout) {
            ((Cart_Layout) context).updateSelectAllState(isAllSelected);
        }
    }
