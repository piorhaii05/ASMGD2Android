...
public class ItemsPaymentAdapter extends RecyclerView.Adapter<ItemsPaymentAdapter.ViewHolderItemsPayment> {
    ...
    private ItemsPaymentModel itemsPaymentModel;
    ...
    public void onBindViewHolder(@NonNull ViewHolderItemsPayment holder, int position) {
        itemsPaymentModel = list.get(position);
    ...
    class ViewHolderItemsPayment extends RecyclerView.ViewHolder {
        ImageView imageItemsProductInHistory;
        TextView txtNameProductInHistory, txtPriceProductInHistory, txtColorProductInHistory, txtSizeProductInHistory, txtQuantityProductInHistory;
